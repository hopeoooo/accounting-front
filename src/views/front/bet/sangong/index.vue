          ...
          <el-card class="box-card-box-list" style="text-align:center">
            <el-row :gutter="0" style="width:100%">
               <el-col :span="24" :xs="24">
                  <div class="f2">
                     <span>${{$t('bet.chip')}}:{{sgSum.sumChip || 0}}</span>
                    <span>${{$t('bet.cash')}}:{{sgSum.sumCash || 0}}</span>
                     <span>฿{{$t('bet.chip')}}:{{sgSum.sumChipTh || 0}}</span>
                    <span>฿{{$t('bet.cash')}}:{{sgSum.sumCashTh || 0}}</span>
                  </div>
               </el-col>
...
.app_zh .game_sg .table-info-bj-red1 td:nth-child(2){
  position: relative;
  &::after{
    content: '请填写卡号';
    position: absolute;
...
.app_en .game_sg .table-info-bj-red1 td:nth-child(2){
  position: relative;
  &::after{
