<template>
  <div class="app-container lh_show">
     ...
     <el-table v-loading="loading" class="betBox" height="920px" :data="betList"  border >
          ...
          <el-table-column :label="$t('Card-number')" align="center" key="card" prop="card"  width="200px"></el-table-column>
           <el-table-column :label="$t('D')" align="center" key="card1" prop="card1"  ></el-table-column>
           <el-table-column :label="$t('TYG')" align="center" key="card2" prop="card2"  ></el-table-column>
           <el-table-column :label="$t('T')" align="center" key="card3" prop="card3"  ></el-table-column>
           
          <!-- <el-table-column label="现有{{$t('bet.chip')}}" align="center" key="chip" prop="chip"   /> -->
