    ...
    <el-row :gutter="20">
      ...
      <el-col :span="24" :xs="24">
        ...
        <el-table v-loading="loading" :data="roleList">
          <el-table-column label="角色" align="center" key="roleName" prop="roleName"  width="160" />
          <el-table-column label="描述" align="center" key="remark" prop="remark"  />
...
<script>
import { getTree,getRoleList,getRoleMenuTree,addRole,updateRole, delRole } from "@/api/account/role";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认该角色？').then(function() {
